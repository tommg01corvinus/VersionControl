...
namespace ExcelExport
{
    public partial class Form1 : Form
    {
        ...
        private void CreateTable()
        {
            ...
            for (int i = 1; i <= headers.Length; i++) xlSheet.Cells[1, i] = headers[i - 1];
            ...
            Excel.Range tableRange = xlSheet.get_Range(GetCell(1, 1), GetCell(1 + Flats.Count, headers.Length));
            tableRange.BorderAround2(Excel.XlLineStyle.xlContinuous, Excel.XlBorderWeight.xlThick);

            Excel.Range firstColumnRange = xlSheet.get_Range(GetCell(2, 1), GetCell(1 + Flats.Count, 1));
            firstColumnRange.Font.Bold = true;
            firstColumnRange.Interior.Color = Color.LightYellow;

            Excel.Range lastColumnRange = xlSheet.get_Range(GetCell(2, headers.Length), GetCell(1 + Flats.Count, headers.Length));
